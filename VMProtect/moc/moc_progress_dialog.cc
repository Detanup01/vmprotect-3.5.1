...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProgressDialog::cancel)) {
                *result = 0;
                return;
            }
        }
...
void GUILog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GUILog::*)(MessageType , IObject * , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUILog::notify)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (GUILog::*)(const QString & , unsigned long long );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUILog::startProgress)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (GUILog::*)(unsigned long long );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUILog::stepProgress)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (GUILog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GUILog::endProgress)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GUILog::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_GUILog.data,
    qt_meta_data_GUILog,
    qt_static_metacall,
    nullptr,
    nullptr
