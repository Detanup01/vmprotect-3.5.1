...
void ExportKeyPairDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ExportKeyPairDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ExportKeyPairDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ExportKeyPairDialog.data,
    qt_meta_data_ExportKeyPairDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
