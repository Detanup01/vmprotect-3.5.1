...
void StdInListenerWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<StdInListenerWin *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (StdInListenerWin::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&StdInListenerWin::receivedCommand)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject StdInListenerWin::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_StdInListenerWin.data,
    qt_meta_data_StdInListenerWin,
    qt_static_metacall,
    nullptr,
    nullptr
} };
