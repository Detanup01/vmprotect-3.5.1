...
void TemplatesWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TemplatesWindow *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TemplatesWindow::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_TemplatesWindow.data,
    qt_meta_data_TemplatesWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
